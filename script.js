...
(() => {
  ...
  const supportInitialMessageInput = document.getElementById("supportInitialMessageInput");
  ...
  const setLoadingState = (disabled) => {
    ...
    supportInitialMessageInput.disabled = disabled;
  ...
  const sendInitialMessage = async () => {
    ...
    const messageText = String(supportInitialMessageInput.value || "").trim();
    if (!messageText && !(initialPhotoFile instanceof File)) {
    ...
    try {
      ...
      supportInitialMessageInput.value = "";
      clearPhotoSelection();
  ...
  supportInitialMessageInput.addEventListener("keydown", (event) => {
