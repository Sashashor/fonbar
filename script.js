...
(() => {
  ...
  const trackTransitionValue = "transform 460ms cubic-bezier(0.22, 0.61, 0.36, 1)";
  ...
  const applyVisualSlide = (nextVisualSlide, animate = true) => {
    ...
    track.style.transform = `translateX(-${visualSlide * 100}%)`;
    isAnimating = animate;
  };
  ...
  const goToSlide = (targetSlide, animate = true) => {
    ...
    currentSlide = normalizeSlideIndex(targetSlide);
